...
def fetch_movie_details():
    ...
    cloud_function_url = 'https://function1-853791711058.europe-west6.run.app'
    
    try:
        print("accessed fetch movie details")
...
def main():
    ...
    if movie_details:
        ...
        if st.button("Search"):
            ...
            search_url = f'https://function2-853791711058.europe-west6.run.app?movie_id={search_movie_id}'
            try:
